...
class WeeklySalesChartTeam extends ConsumerStatefulWidget {
  @override
  ConsumerState<WeeklySalesChartTeam> createState() =>
      _WeeklySalesChartTeamState();
}

class _WeeklySalesChartTeamState extends ConsumerState<WeeklySalesChartTeam> {
